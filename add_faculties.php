...
<body>
    ...
    <div class="title">
        ...
        <span class="heading">ECS Department</span>
        ...
        <ul>
            ...
            <li class="dropdown" onclick="toggleDisplay('3')">
                ...
                <div class="dropdown-content" id="3">
                    <a href="add_faculties.php" >Add Faculty</a>
    ...
    <div class="footer">
        <!-- <span>Designed & Coded By  SHARIQUE KHAN</span> -->
    </div>
</body>
</html>
...
<?php 
    ...
    if (isset($_POST['faculty_name'],$_POST['faculty_id'])) {
        $faculty=$_POST["faculty_name"];
        $id=$_POST["faculty_id"];

        // validation
        if (empty($faculty) or empty($id) or preg_match("/[a-z]/i",$id)) {
            if(empty($faculty))
        ...
        $sql = "INSERT INTO `faculty` (`faculty`, `id`) VALUES ('$faculty', '$id')";
